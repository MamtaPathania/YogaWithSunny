      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <Link to="/about" className="bg-yoga-600 hover:bg-yoga-700 text-white px-8 py-4 rounded-full font-medium transition-all shadow-lg hover:shadow-yoga-500/30 flex items-center gap-2 group transform hover:-translate-y-1">
